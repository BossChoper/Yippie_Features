# functional; gets some menu information from business
# Favorite
import requests
...
def scrape_yelp_menu(url):
    ...
    try:
        ...
        # Find all menu sections (h2 headings)
        ...
        for section in sections:
            ...
            while current_element and current_element != next_section:
                if current_element.name == 'h4':
                    ...
                    # Process siblings until next item/section
                    desc_elements = []
                    price_found = False
                    ...
                    if desc_elements:
                        ...
                        if allergens:
                            item['allergens'] = [a.strip() for a in allergens[0].split(',')]
